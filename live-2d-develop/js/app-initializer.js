...
const { LocalToolManager } = require('./local-tool-manager.js');
const { VoiceChatInterface } = require('./voice-chat.js');
const { UIController } = require('./ui-controller.js');
const { TTSFactory } = require('./tts-factory.js');
const { ModelSetup } = require('./model-setup.js');
const { BarrageManager } = require('./barrage-manager.js');
const { LiveStreamModule } = require('./LiveStreamModule.js');
const { AutoChatModule } = require('./auto-chat.js');
const { IPCHandlers } = require('./ipc-handlers.js');
const { LLMHandler } = require('./llm-handler.js');
