...
## 官网：http://fake-neuro.natapp1.cc


它包含客服功能，遇到项目部署中的任何问题，可以向肥牛客服询问。以及项目中各个功能如何使用都会逐渐更新在官网中

会逐渐增加云端配置API，比如语音模型、记忆模型、肥牛的微调模型等都会逐渐上架。

到时即可以本地配置也可以使用官网提供云端API配置，自由选择你想要的。

同时，我们会逐渐开发工具市场，用户可以自己上传制作的mcp工具和function call工具。

你也可以在工具市场里下载你喜欢的工具。例如，根据图片找到源头网站、让AI去爬取你需要的数据、或让AI帮你独立做PPT等等。

---
### 整合包
不想搞那么多工作可以直接下载整合包，解压即用：
